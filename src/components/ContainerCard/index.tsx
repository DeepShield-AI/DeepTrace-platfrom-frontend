import { CloudServerOutlined, CodeOutlined } from '@ant-design/icons';
...
const ContainerCard: React.FC<Props> = ({
  ...
  return (
    <div ref={rootRef} style={{ display: 'flex', flexDirection: 'column', height: '520px' }}>
      <Badge.Ribbon text={getStatusText(container.state)} color={getStatusColor(container.state)}>
        <Card
          hoverable
          ...
          <Meta
            ...
            description={
              ...
              >
                ...
                <div style={{ color: '#8c8c8c', fontSize: 13, marginBottom: 8 }}>
                  <b>创建时间：</b>
                  {container.time || container.createTime || '-'}
                </div>
                <div style={{ color: '#8c8c8c', fontSize: 13, marginBottom: 8 }}>
                  <b>状态：</b>
                  {container.state || '-'}
