...
const logTableQuery = async (data) => {
  return makeRequest(async () => {
    try {
      const { current = 1, pageSize = 10, keyword } = data;
...
// 0. 查询字段枚举值映射
// fieldName 必填 String
const getFieldEnumMapping = async (fieldName) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.get(`/api/trace/query/field/enum-mapping`, {
        params: { fieldName },
      });
      const { data = [] } = res;
      return data;
...
// 1. 查询字段可选值
const getFieldOptions = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.get(`/api/trace/query/field/options`, {
        params,
      });
      const { data = {} } = res;
      return data;
...
const getFilterFields = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.get(`/api/trace/query/filter/fields`, {
        params,
      });
      const { data = {} } = res;
      return data;
...
const queryGraphNodeMetrics = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/graph/node/metrics`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
// 4. 服务节点列表筛选及其指标
const queryTableNodeMetrics = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/table/node/metrics`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
const queryGraphEdgeMetrics = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/graph/edge/metrics`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
// 6. 查询单个节点Span明细（分页）
const querySpanDetails = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/span/details`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
// 7. 查询节点请求数时间序列
const queryNodeCountTimeSeries = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/node/count_time_series`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
// 8. 查询节点错误数时间序列
const queryNodeErrorTimeSeries = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/node/error_time_series`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
// 9. 查询节点延迟时间序列
const queryNodelatencyTimeSeries = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/node/latency_time_series`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
const querySpanDetailsByTrace = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.get(`/api/trace/query/span/details/by_trace`, {
        params,
      });
      const { data = [] } = res;
      return data;
...
const queryTraceList = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/trace/list`, params);
      const { data = {} } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
const queryTraceLatencyTimeSeries = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/trace/latency_time_series`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
const queryTraceErrorTimeSeries = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/trace/error_time_series`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
const queryTraceCountTimeSeries = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/trace/count_time_series`, params);
      const { data = [] } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
// 15. 查询Span列表（分页）
const querySpanList = async (params) => {
  return makeRequest(async () => {
    try {
      const res = await topologyApi.post(`/api/trace/query/span/list`, params);
      const { data = {} } = res;
      return data;
    } catch (error) {
      console.error('==ERROR==', error);
...
export {
  ...
  queryNodeCountTimeSeries,
  queryNodeErrorTimeSeries,
  queryNodelatencyTimeSeries,
  querySpanDetails,
  querySpanDetailsByTrace,
  querySpanList,
  queryTableNodeMetrics,
  queryTraceCountTimeSeries,
  queryTraceErrorTimeSeries,
  queryTraceLatencyTimeSeries,
  queryTraceList,
};